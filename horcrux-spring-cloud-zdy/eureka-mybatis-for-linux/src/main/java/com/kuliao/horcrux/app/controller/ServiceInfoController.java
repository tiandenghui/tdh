...
public class ServiceInfoController {
    ...
    public int insertOneUser(@RequestParam("serviceId") Integer serviceId,@RequestParam("userName") String userName, @RequestParam("serviceName") String serviceName, @RequestParam("servicePort") String servicePort) {
        return serviceInfoService.insertOneService(serviceId,userName, serviceName, servicePort);
    }
